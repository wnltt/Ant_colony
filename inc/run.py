...
def verify(target_list, poc_modole_list, output_path):    #target_list要检测的url列表，poc_modole_list所以poc列表， config.output_path输出文件路径
    # try:
        thread_pool = thread.ThreadPool(config.max_thread) #线程池默认最大三百
